package com.example.logincrud.pages.login
...
@Composable
fun SubmitButton(textId: String, inputValid: Boolean, onClic: () -> Unit) {
...
fun EmailInput(emailState: MutableState<String>,
    ...
    InputField(
        ...
        labeId = labeId,
        keyoardType = KeyboardType.Email
    )
